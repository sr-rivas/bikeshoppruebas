...
### 👤 Login de Usuario
- Inicio parfa usuarios y registro
...
- `login.html` - Login de inicio de sesion y registro
- `politicas-devolucion.html` - Plantilla para las politicas de devoluciones
- `proteccion-datos-html` - Plantilla para proteccion de datos
- `termino-de-uso-html` - Plantilla para los terminos de uso
- `preguntas.frecuentes.html` - Plantilla para las preguntas frecuentes
...
- `login.html` - Login de usuario y pedidosregistros

### Estilos
- `styles.css` - Estilos personalizados con variables CSS
- `checkout.css` - Estilos personalizado especialmente para checkout
- `login.css` - Estilos personalizados para login de usuarios y registros
...
### Para de usuarios:
1. Inicio de sesion de usuarios correo y contraseña
2. Recuperacion de contraseñas
3. Registros para nuevos usuarios
...
- En la pagina login no esta conectado a la base datos del perfil, es un ligin independiente.
